...
#else
  #define OMC_FILE "/home/marius/om_wdir/Buildings.Fluid.FMI.ExportContainers.Examples.FMUs.PumpCircuit/Buildings_Fluid_FMI_ExportContainers_Examples_FMUs_PumpCircuit.fmutmp/sources/Buildings_Fluid_FMI_ExportContainers_Examples_FMUs_PumpCircuit_05evt.c"
#endif
...
int Buildings_Fluid_FMI_ExportContainers_Examples_FMUs_PumpCircuit_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  tmp0 = GreaterEqZC((data->localData[0]->realVars[68] /* fluPor[2].m_flow variable */), 0.0, data->simulationInfo->storedRelations[0]);
  gout[0] = (tmp0) ? 1 : -1;

  tmp1 = GreaterEqZC((data->localData[0]->realVars[67] /* fluPor[1].m_flow variable */), 0.0, data->simulationInfo->storedRelations[1]);
  gout[1] = (tmp1) ? 1 : -1;
...
int Buildings_Fluid_FMI_ExportContainers_Examples_FMUs_PumpCircuit_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  ...
  if(evalforZeroCross) {
    tmp2 = GreaterEqZC((data->localData[0]->realVars[68] /* fluPor[2].m_flow variable */), 0.0, data->simulationInfo->storedRelations[0]);
    data->simulationInfo->relations[0] = tmp2;

    tmp3 = GreaterEqZC((data->localData[0]->realVars[67] /* fluPor[1].m_flow variable */), 0.0, data->simulationInfo->storedRelations[1]);
    data->simulationInfo->relations[1] = tmp3;
  } else {
    data->simulationInfo->relations[0] = ((data->localData[0]->realVars[68] /* fluPor[2].m_flow variable */) >= 0.0);

    data->simulationInfo->relations[1] = ((data->localData[0]->realVars[67] /* fluPor[1].m_flow variable */) >= 0.0);
  }
