...
if __name__ == "__main__":
    ...
    data["phi_h"] = dat[en_cols].sum(axis=1).diff().fillna(0)*1000
    ...
    start = "2023-02-13 00:00:00+01:00"
    stop = "2023-02-20 00:00:00+01:00"
    ...
    param_guess = ca.DM([0.1,0.1,0.1,1E6,1E6,1E7,5])
    ...
    with ParameterEstimation(config=cfg_path,
        ...
        ax = (y_data["Ti"]-273.15).plot(color="black", linestyle="dashed", drawstyle="steps")
